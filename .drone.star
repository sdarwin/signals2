...
def main(ctx):
  ...
  linux_cxx("CMAKE_TEST=True Job 14", "g++", packages="binutils-gold gdb libc6-dbg", buildtype="b5847f804b-a16f359ef1", buildscript="drone", image=linuxglobalimage, environment={'CMAKE_TEST': 'True', 'DRONE_JOB_UUID': 'fa35e19212'}, globalenv=globalenv),
  ...
  linux_cxx("COMMENT=Coverity Scan B2_TOOLSET=clang Job 18", "g++", packages="binutils-gold gdb libc6-dbg", buildtype="b5847f804b-cce9827eb5", buildscript="drone", image=linuxglobalimage, environment={'COMMENT': 'Coverity Scan', 'B2_TOOLSET': 'clang', 'DRONE_JOB_UUID': '9e6a55b6b4'}, globalenv=globalenv),
    ]
